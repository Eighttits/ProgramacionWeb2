...
<div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                                        <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Agregar Producto Nuevo</h1>
                    ...
                    <form id="addProductForm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col">
                                <label for="productDepartment">Departmento:</label>
                        ...
                        <a class="btn btn-primary mt-3" onclick="guardarProducto()" type="button">Guardar</a>
                    </form>
